...
```sql
menu_items (id, name, category, style, base_price, has_bean_choice, sort_order, active)
...
**Staff Panel — flow การกดสร้าง QR (wireframe แรก ทำใน claude.ai/design ต่อได้)**
1. กด **ร้อน/เย็น** ก่อนเป็นอันดับแรก (เก็บเป็นข้อมูล CRM ด้วย ไม่กระทบราคา)
2. กดหมวดเมนู: Signature / Coffee / Matcha / Non-Coffee / Snack
